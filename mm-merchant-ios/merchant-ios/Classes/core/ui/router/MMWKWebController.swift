...
//    private final let OffsetAllowance = CGFloat(5)
    ...
    public func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        let allow = {
            //以后再想办法
//            let authorization = navigationAction.request.allHTTPHeaderFields?["Authorization"]
//            if authorization == nil || authorization!.isEmpty {
////                var request = navigationAction.request
////                request.setMMAppPrivateInfo()
//                navigationAction.request.setMMAppPrivateInfo()
//            }
