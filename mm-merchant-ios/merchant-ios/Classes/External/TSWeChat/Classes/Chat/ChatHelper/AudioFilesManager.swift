...
class AudioFilesManager {
    ...
    /**
     创建录音的文件夹
     */
    class private func createAudioFolder(_ folderName :String) -> URL {
    ...
    /**
     创建录音的文件夹, amr 格式
     */
    private class var amrFilesFolder: URL {
    ...
    /**
     创建录音的文件夹, wav 格式
     */
    private class var wavFilesFolder: URL {
    ...
    /**
     ...
     - parameter path: 路径
     */
    private class func deleteFilesWithPath(_ path: String) {
        let fileManager = FileManager.default
        do {
