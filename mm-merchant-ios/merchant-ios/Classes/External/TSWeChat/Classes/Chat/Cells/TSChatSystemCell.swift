...
private let kChatInfoLabelMaxWidth : CGFloat = ScreenWidth - 40*2
private let kChatInfoLabelMinWidth : CGFloat = 90
...
class TSChatSystemCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        self.infomationLabel.setFrameWithString(model.messageContent!, width: kChatInfoLabelMaxWidth, minWidth: kChatInfoLabelMinWidth)
        ...
        self.infomationLabel.left = (ScreenWidth - self.infomationLabel.width) / 2
    ...
    class func layoutHeight(_ model: ChatModel) -> CGFloat {
        ...
        let stringHeight: CGFloat = (model.messageContent?.stringHeightWithMaxWidth(kChatInfoLabelMaxWidth, font: kChatInfoFont) ?? 0)
