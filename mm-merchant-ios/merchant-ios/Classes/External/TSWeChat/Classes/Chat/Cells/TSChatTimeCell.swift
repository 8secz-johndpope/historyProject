...
private let kChatTimeLabelMaxWidth : CGFloat = ScreenWidth - 30*2
private let kChatTimeLabelMinWidth : CGFloat = 30
private let kChatTimeLabelPaddingLeft: CGFloat = 10   //左右分别留出 6 像素的留白
...
class TSChatTimeCell: UITableViewCell {    
    @IBOutlet weak var timeLabel: UILabel! {didSet {
        ...
        timeLabel.layer.backgroundColor = UIColor.secondary1().cgColor
        }}
    var model: ChatModel?
    ...
    override func layoutSubviews() {
        ...
        self.timeLabel.setFrameWithString(message, width: kChatTimeLabelMaxWidth, minWidth: kChatTimeLabelMinWidth)
        self.timeLabel.width = self.timeLabel.width + kChatTimeLabelPaddingLeft*2  //左右的留白
        self.timeLabel.left =  (ScreenWidth - self.timeLabel.width) / 2
