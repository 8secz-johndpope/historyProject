...
- (UIImage *)blurredImageWithRadius:(CGFloat)radius iterations:(NSUInteger)iterations tintColor:(UIColor *)tintColor {
	return [self blurredImageWithRadius:radius iterations:iterations tintColor:tintColor useBitmapInfo:YES];
}

- (UIImage *)blurredImageWithRadius:(CGFloat)radius iterations:(NSUInteger)iterations tintColor:(UIColor *)tintColor useBitmapInfo:(BOOL)useInfo
{
	...
	CGImageAlphaInfo info = (CGImageAlphaInfo)CGImageGetBitmapInfo(imageRef);
	if (!useInfo) {
